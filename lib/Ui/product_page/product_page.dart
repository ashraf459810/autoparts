    ...
    return BlocProvider(
        ...
        child: Scaffold(
          ...
          body: Column(
            children: [
              Expanded(
                  child: widget.searchResult.attachments.isNotEmpty
                      ? Image.network(
                          widget.searchResult.attachments[0].publicUrl,
                          width: size.width,
                          height: 200,
                          fit: BoxFit.fill,
                        )
              ...
              Expanded(
                child: TabBarView(
                  ...
                  children: [
                    DetailsTab(
                        widget.searchResult.brand.name,
                        widget.searchResult.product.name,
                        widget.searchResult.price.toString()),
                  ],
                      ...
                      child: Builder(
                        builder: (context) => InkWell(
                          onTap: () {
                            context
                                .read<CartBloc>()
                                .add(AddProductEvent(widget.searchResult.id));
                          },
                          child: Row(
