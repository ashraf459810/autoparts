    ...
    return WillPopScope(
        ...
        child: BlocProvider(
            ...
            child: Scaffold(
              ...
              child: BlocConsumer<VendoroffernotBloc, VendoroffernotState>(
                ...
                return vendorOfferNotificationModel != null
                    ? Container(
                        child: vendorOfferNotificationModel.daysToDeliver ==
                                null
                            ? Container(
                                child: vendorOfferNotificationModel.status !=
                                        "NOT_AVAILABLE"
                                    ? Row(
                                        crossAxisAlignment:
                                        ...
                                        children: [
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                    "product state ${vendorOfferNotificationModel.type}"),
                                                SizedBox(
                                                    height: size.height * 0.01),
                                                Text(
                                                  ...
                                                  return GestureDetector(
                                                    onTap: () {
                                                      if (answerd) {
                                                        Fluttertoast.showToast(
                                                            msg:
                                                                "you can't add offer after rejecting it",
                                                            toastLength: Toast
                                                                .LENGTH_SHORT,
                                                            gravity:
                                                                ToastGravity
                                                        ...
                                                        print(
                                                            "here the price $price");
                                                        context.read<VendoroffernotBloc>().add(
                                                            AddOfferEvent(
                                                                days: int.parse(
                                                                    daystodeliver),
                                                                offerid: widget
