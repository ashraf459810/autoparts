                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(50),
                                  color: Colors.white),
                              child: widget.cart[index].product.attachments
                                      .isNotEmpty
                                  ? Image.network(widget.cart[index].product
                          ...
                          children: [
                            ...
                            Text(widget.cart[index].sourceTypeName,
                                style: TextStyle(
                                    ...
                                    fontWeight: FontWeight.bold,
                                    color: green)),
                            Text(widget.cart[index].fullPrice.toString(),
                                style: TextStyle(
                                  fontSize: 15,
                                  fontWeight: FontWeight.bold,
                                  color: lightOrange,
                          ...
                          builder: (context) => InkWell(
                            onTap: () {
                              ...
                              context.read<CartBloc>().add(ConfirmCart(
                                  ...
                                  widget.x,
                                  widget.y,
                                  widget.street != null ? widget.street : ""));
                            },
                            child: Container(
